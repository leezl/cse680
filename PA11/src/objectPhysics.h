...
public:
    ...
    void setRigidBody(glm::mat4 model, std::string motionType);
    void setMotion(glm::vec3 scaler, glm::mat4 model, glm::vec3 inertia);
    void resetMotion(glm::mat4 model, glm::vec3 scale = glm::vec3(1.0,1.0,1.0));

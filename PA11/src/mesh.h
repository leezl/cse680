...
struct BoardConfig {
    ...
    glm::vec3 startLocation2;
    glm::vec3 stopLocation;
    //hole radius, so we can scale the ball?
    //scaling? 
    //translation?
};
...
class Mesh {
  public:
    ...
    void addPhysics(std::string shapeType, std::string motionType, PhysicsWorld* world, glm::mat4 model, glm::vec3 scale);
    void resetPhysics(glm::mat4 model, glm::vec3 scaler);
    void disablePhysics();
    void enablePhysics();
